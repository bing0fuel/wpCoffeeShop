...
/**
 * Fully initiate the wpCoffeeShop admin-side plugin. Note that this plugin requires your instance of WordPress
 * to be running with SSL to work due to limitations of the Navigator.geolocation API
 *
 * See https://developer.mozilla.org/en-US/docs/Web/API/Navigator/geolocation for more details
 *
 * @link              suwdo.com
 * @since             1.0.0
 ...
 * Plugin URI:        https://suwdo.com/2017/02/wpcoffeeshop/
...
# Enable the AJAX/JS
add_action('wp_ajax_wp_coffeeshop_get', 'gimme_the_liquid_gold');
