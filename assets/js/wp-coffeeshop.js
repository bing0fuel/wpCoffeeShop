jQuery( document ).ready( function( $ ) {
    ...
    var postData = {
        'action': 'wp_coffeeshop_get',
        'wp_coffee_shop_lat': 39.7439847,
        'wp_coffee_shop_long': -104.9368033
    };


    // Make sure the browser has Navigator geolocation available before requesting lat/long
    if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            // Once position is found, send this off to the backend admin AJAX
